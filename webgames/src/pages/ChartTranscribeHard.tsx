...
function generateData(): DataPoint[] {
  ...
  const hours = 6; // Increased hours for hard version
...
export const TASK_ID_ChartTranscribeHard = "chart-transcribe-hard";
export const PASSWORD_ChartTranscribeHard = "DataScribeHard2024";

const ChartTranscribeHard: React.FC = () => {
  const { recordSuccess } = useTaskAnalytics(TASK_ID_ChartTranscribeHard);
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-500 via-pink-500 to-purple-600 p-8">
      ...
      <div className="flex justify-center mb-8">
        <div className="bg-white rounded-xl p-6 max-w-2xl shadow-sm">
          <h1 className="text-3xl font-bold text-center mb-4 text-gray-800">
            Chart Transcribe Challenge (Hard)
          </h1>
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-green-100 border border-green-200 rounded-lg p-6 shadow-lg w-full max-w-2xl">
            ...
            <p className="text-green-700">
              The password is: {PASSWORD_ChartTranscribeHard}
            </p>
          </div>
        </div>
      )}
      ...
      <div className="bg-white rounded-xl p-6 mb-8 shadow-lg">
        <div className="h-[400px]">
          {" "}
          {/* Increased height for more data */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full h-64 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" // Increased height
...
export default ChartTranscribeHard;
